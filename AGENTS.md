...
**MCP gateway endpoint:** `POST /mcp` — Model Context Protocol (Streamable HTTP transport, spec `2025-06-18`). Single JSON-RPC 2.0 endpoint exposing 6 tools (`lemonade_list_models`, `lemonade_chat`, `lemonade_embed`, `lemonade_transcribe_audio`, `lemonade_generate_speech`, `lemonade_generate_image`). GET returns 405.
